<template>
	<view class="uv-loadmore" :style="[{
				backgroundColor: bgColor,
				paddingBottom: $uv.addUnit(marginBottom),
				paddingTop: $uv.addUnit(marginTop),
